...
$(function() {
   ...
   // removeHoverCSSRule();
    ...
    if(isMobile){
      ...
      $('.back-to-home').addClass('hidden-global');
      ...
      $(window).scroll(function(){
          if( $(window).scrollTop() > 100){
              ...
              $('.back-to-home').removeClass('hidden-global');
