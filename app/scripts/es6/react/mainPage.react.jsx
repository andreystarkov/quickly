                        ...
                        <div className="row main-logo">
                            <div className="col-lg-5">
                                <div className="quickly-logo">
                                    <svg className="zoomer-image" xmlns="http://www.w3.org/2000/svg" id="svg2" fill-rule="evenodd" viewBox="0 0 13214.144 12912.382" clip-rule="evenodd" image-rendering="optimizeQuality" shape-rendering="geometricPrecision" text-rendering="geometricPrecision">
                                      <g>
                                        <g>
                            ...
                            <div className="col-lg-6 text">
                                <h1>Квикли</h1>
                                <p>Лучший способ получать то, что хочешь, быстро и без всякой нелепой хуйни</p>
                            </div>
                        </div>
                    </div>
...
var SingleCuisine = React.createClass({
    toggleCategory: function(cuisine){
        CompanyListActions.selectByCuisine(this.props.cuisine.cuisine_id);
        showScreen('screen-company-list');
    },
    render: function(){
        return(
